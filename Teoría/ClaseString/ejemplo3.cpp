...
int main ()
{
    ...
    cout << boolalpha; // setea la salida en pantalla para mostrar true o false;

    cout << "Comparando s y s2 lexicographicamente (s < s2):\n";

    cout << "usando la ócomparacin por default (operador <): ";
    cout << lexicographical_compare(i,e,i2,e2) << endl;


    cout << "Usando la funcion mi_comparador: ";
    cout << std::lexicographical_compare(i,i+5,i2,i2+9, mi_comparador) << endl;
